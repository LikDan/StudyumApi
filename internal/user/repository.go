...
type Repository interface {
	GetUserByID(ctx context.Context, id primitive.ObjectID) (global.User, error)
	GetUserViaRefreshToken(ctx context.Context, refreshToken string) (global.User, error)
	GetUserByLogin(ctx context.Context, email string) (global.User, error)

	SignUp(ctx context.Context, user global.User) (primitive.ObjectID, error)
	SignUpStage1(ctx context.Context, user global.User) error
	...
	UpdateUser(ctx context.Context, user global.User) error
	UpdateUserByID(ctx context.Context, user global.User) error

	CreateCode(ctx context.Context, code SignUpCode) error

	SetRefreshToken(ctx context.Context, old string, session global.Session) error
	AddSessionByUserID(ctx context.Context, session global.Session, id primitive.ObjectID, sessionsAmount int) error
...
func (u *repository) GetUserByID(ctx context.Context, id primitive.ObjectID) (user global.User, err error) {
	err = u.UsersCollection.FindOne(ctx, bson.M{"_id": id}).Decode(&user)
	return
}

func (u *repository) GetUserViaRefreshToken(ctx context.Context, refreshToken string) (user global.User, err error) {
	err = u.UsersCollection.FindOne(ctx, bson.M{"sessions.refreshToken": refreshToken}).Decode(&user)
	return
}

func (u *repository) SignUp(ctx context.Context, user global.User) (primitive.ObjectID, error) {
...
func (u *repository) SignUpStage1(ctx context.Context, user global.User) error {
...
func (u *repository) UpdateUser(ctx context.Context, user global.User) error {
	_, err := u.UsersCollection.UpdateByID(ctx, user.Id, bson.M{"$set": user})
	return err
}

func (u *repository) UpdateUserByID(ctx context.Context, user global.User) error {
	_, err := u.UsersCollection.UpdateByID(ctx, user.Id, bson.M{"$set": user})
	return err
}

func (u *repository) SetRefreshToken(ctx context.Context, old string, session global.Session) error {
	_, err := u.UsersCollection.UpdateOne(ctx, bson.M{"sessions.refreshToken": old}, bson.M{"$set": bson.M{"sessions.$": session}})
	return err
}

func (u *repository) AddSessionByUserID(ctx context.Context, session global.Session, id primitive.ObjectID, sessionsAmount int) error {
...
func (u *repository) GetUserByLogin(ctx context.Context, login string) (global.User, error) {
