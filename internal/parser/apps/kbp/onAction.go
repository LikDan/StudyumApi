...
func (a *app) OnMarkAdd(_ context.Context, mark entities.Mark, lesson entities.Lesson) entities.ParsedInfoType {
	logrus.Infof("set mark %v, with lesson %v", mark, lesson)
	return nil
}

func (a *app) OnMarkEdit(_ context.Context, mark entities.Mark, lesson entities.Lesson) entities.ParsedInfoType {
...
func (a *app) OnLessonAdd(_ context.Context, lesson entities.Lesson) entities.ParsedInfoType {
	logrus.Infof("add lesson %v", lesson)
	return nil
}

func (a *app) OnLessonEdit(_ context.Context, lesson entities.Lesson) entities.ParsedInfoType {
